...
public class ReservationService implements IReservationService {
    ...
    public Reservation findById(String id) {
        Optional<Reservation> reservationOpt = repo.findById(id);
    ...
    public void affectReservationAChambre(String idRes, long idChambre) {
        Optional<Reservation> reservationOpt = repo.findById(idRes);
        Optional<Chambre> chambreOpt = chambreRepository.findById(idChambre);

        if (reservationOpt.isPresent() && chambreOpt.isPresent()) {
            ...
            log.warn("Réservation avec ID {} ou Chambre avec ID {} non trouvée.", idRes, idChambre);
        }
    }
